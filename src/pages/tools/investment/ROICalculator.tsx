...
export default function ROICalculator() {
  ...
  // ✅ JSON-LD structured data - WebApplication schema for ROI calculator
  const jsonLd = {
  ...
  return (
    <div className="min-h-screen py-12 px-6">
      ...
      <SEOHelmet
        ...
        description="Free ROI calculator to calculate return on investment percentage. Calculate ROI, net profit, and total returns on investments with additional costs. Best ROI calculator for USA, Canada, UK, Australia."
        keywords="ROI calculator, return on investment calculator, investment ROI calculator, ROI percentage calculator, net profit calculator, investment returns calculator, ROI formula calculator, business ROI calculator"
        canonical="https://www.fincalcbox.com/tools/investment/roi-calculator"
        jsonLd={jsonLd}
      />
