...
export default function InflationCalculator() {
  ...
  // ✅ JSON-LD structured data - WebApplication schema for inflation calculator
  const jsonLd = {
  ...
  return (
    <div className="min-h-screen py-12 px-6">
      ...
      <SEOHelmet
        ...
        description="Free inflation calculator to calculate the impact of inflation on your money. Calculate future value, purchasing power, and value lost due to inflation. Best inflation calculator for USA, Canada, UK, Australia."
        keywords="inflation calculator, purchasing power calculator, future value calculator, inflation impact calculator, value lost calculator, inflation rate calculator, money value calculator, CPI calculator"
        canonical="https://www.fincalcbox.com/tools/investment/inflation-calculator"
        jsonLd={jsonLd}
      />
