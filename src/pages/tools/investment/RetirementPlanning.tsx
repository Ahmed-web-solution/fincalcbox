...
import { Target, Calculator, DollarSign, Clock, ArrowLeft } from "@/components/icons";
...
export default function RetirementPlanning() {
  ...
  // ✅ JSON-LD structured data - WebApplication schema for retirement planning calculator
  const jsonLd = {
  ...
  return (
    <div className="min-h-screen py-12 px-6">
      ...
      <SEOHelmet
        ...
        description="Free retirement planning calculator to plan your retirement savings and goals. Calculate retirement corpus, total savings, and investment returns. Best retirement calculator for USA, Canada, UK, Australia."
        keywords="retirement planning calculator, retirement savings calculator, retirement corpus calculator, 401k retirement calculator, IRA retirement calculator, retirement planning tool, retirement calculator, pension calculator"
        canonical="https://www.fincalcbox.com/tools/investment/retirement-planning"
        jsonLd={jsonLd}
      />
          ...
          <NeuCard>
            <div className="space-y-8">
              ...
              <div className="mt-6 p-4 neu-inset rounded-xl bg-accent/5">
                <p className="text-sm text-muted-foreground">
                  <strong>Advisory Note:</strong> This calculator provides estimates for informational purposes only. 
