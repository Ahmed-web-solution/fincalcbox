...
export default function CAGRCalculator() {
  ...
  // ✅ JSON-LD structured data - WebApplication schema for CAGR calculator
  const jsonLd = {
  ...
  return (
    <div className="min-h-screen py-12 px-6">
      ...
      <SEOHelmet
        ...
        description="Free CAGR calculator to calculate Compound Annual Growth Rate. Calculate CAGR percentage, total returns, and investment growth over time. Best CAGR calculator for USA, Canada, UK, Australia."
        keywords="CAGR calculator, compound annual growth rate calculator, investment growth calculator, CAGR percentage calculator, annualized return calculator, investment CAGR calculator, CAGR formula calculator"
        canonical="https://www.fincalcbox.com/tools/investment/cagr-calculator"
        jsonLd={jsonLd}
      />
